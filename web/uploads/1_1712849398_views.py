from app01.models import User, Code, OpLog
        ...
        with connection.cursor() as cursor:
            ...
            for a in data_list:
                if name == a[2] and pwd == a[3]:
                    ...
                    print('cuocuocuocucocuocoocouocuouououcoucc')
...
def main(req):
    ...
    return render(req, 'index.html', {'account': info['account']})

def welcome(req):
    print('buhuibuhuibuhhuibuhui')
