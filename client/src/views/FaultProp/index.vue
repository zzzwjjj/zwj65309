<template>
  <div>
    ...
    <el-dialog width="40%" title="故障传播图"  v-model="dialogTableVisible">
...
import {getList,getListDetail} from "@/apis/faultProp.js"
export default {
  data() {
    return {
  ...
  methods: {
    ...
    async showCallGraph(data) {
     ...
     await getListDetail({file:data.file}).then((res) => {
        console.log(res,"getListDetail")
        let result = res.data
        let  categories = [
            {
              "name": "A"
