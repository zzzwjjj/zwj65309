...
def create_call_graph(source_code):
    ...
    new_values = range(len(nodes_dict))
    for key, new_value in zip(nodes_dict.keys(), new_values):
        nodes_dict[key] = new_value
    print(nodes_dict)
...
def code_locate(code:str,errorfunction:str):
        # 获得代码分析
        ...
        if len(M)==0:
            ...
            return (function_call_graph_json,result_set)
